...
<ol>
    <li>Go to the youngstorage.in website and log in to your account.</li>
    <li>Navigate to the "Labs" section.</li>
...
<ol>
    <li>Go to the "Network" tab on youngstorage.in.</li>
...
<ol>
    ...
    <li>Confirm the VPN connection by checking the latest handshake in the WireGuard application or on the network tab of youngstorage.in.</li>
</ol>

<h2>Step 5: Connect to Instance via SSH</h2>
<ol>
    <li>Open Visual Studio Code (VSCode) on your local system.</li>
